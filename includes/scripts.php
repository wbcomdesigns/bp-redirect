...
if( !class_exists( 'BPRedirectScriptsStyles' ) ) {
	class BPRedirectScriptsStyles{
		...
		public function bp_redirect_scripts_enqueue() {
			wp_enqueue_script( 'jquery-ui-core' );
			wp_enqueue_script( 'jquery-ui-accordion' );
			wp_enqueue_script( 'bp-redirect-js', BP_REDIRECT_PLUGIN_URL.'admin/assets/js/bp-redirect.js', array('jquery') );
			wp_enqueue_style( 'bp-redirect-css', BP_REDIRECT_PLUGIN_URL.'admin/assets/css/bp-redirect.css' );
