...
<div class="wbcom-tab-content">
	<div class="wbcom-welcome-main-wrapper">
		<div class="wbcom-welcome-head">
			<p class="wbcom-welcome-description"><?php esc_html_e( 'BuddyPress Redirect plugin redirects user to their profile on a login and logout.', 'buddypress-member-blog' ); ?></p>
			...
			<div class="wbcom-welcome-support-info">
				...
				<div class="wbcom-support-info-wrap">
					<div class="wbcom-support-info-widgets">
						...
						<p><?php esc_html_e( 'We have prepared an extensive guide on BuddyPress Redirect to learn all aspects of the plugin. You will find most of your answers here.', 'buddypress-member-blog' ); ?></p>
						<a href="<?php echo esc_url( 'https://docs.wbcomdesigns.com/doc_category/buddypress-redirect/' ); ?>" class="button button-primary button-welcome-support" target="_blank"><?php esc_html_e( 'Read Documentation', 'buddypress-member-blog' ); ?></a>
						</div>
					</div>
